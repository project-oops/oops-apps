...
#define HOME_MAX_ITEMS 18
#define HOME_MAX_TITLES 24
...
typedef enum home_layout {
    HOME_LAYOUT_XMB = 0,    /* Cross Media Bar (PS3 / PSP) */
    HOME_LAYOUT_LIST = 1,   /* Framed column (PS1 / PS2) */
    HOME_LAYOUT_BLADES = 2, /* Overlapping panels (Xbox 360) */
    HOME_LAYOUT_TILES = 3   /* Tiles over detail strip (current-generation UX) */
} home_layout_t;
...
#define HOME_REPEAT_DELAY_FRAMES 24
#define HOME_REPEAT_EVERY_FRAMES 4
