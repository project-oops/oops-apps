...
typedef struct home_skin {
    ...
    int (*item_count)(const struct home_model *m, const struct home_skin *skin,
                      int cat_idx);
    ...
    /* Rendering hooks */
    int (*render_main)(oops_surface_t *surf, const struct home_model *m,
                       const struct home_skin *skin);
    int (*render_background)(oops_surface_t *surf, const struct home_model *m,
                             const struct home_skin *skin);
} home_skin_t;
...
void home_draw_title_icon(oops_surface_t *surf, const struct home_title *title, int x,
                          int y, int w, int h, const home_theme_t *theme);
void home_draw_cursor(oops_surface_t *surf, int x, int y, int w, int h,
                      const home_theme_t *theme);
int home_get_category_item_count(const struct home_model *m,
                                 const struct home_skin *skin, int cat_idx);
void home_get_category_item_info(const struct home_model *m,
                                 const struct home_skin *skin, int cat_idx,
                                 int item_idx, const char **out_name,
                                 const char **out_sub,
