...
#define TRAMPOLINE_POOL_PAGES 32u
#define PAGE_SIZE 0x1000u

#if defined(__x86_64__)
__asm__(".text\n"
        ".globl tracer_thunk_pool\n"
        ".align 16\n"
        "tracer_thunk_pool:\n"
        ".set i, 0\n"
        ".rept 1024\n"
        "    push $i\n"
        "    jmp tracer_common_dispatcher\n"
        "    .align 16, 0x90\n"
        "    .set i, i + 1\n"
        ".endr\n"
        "\n"
        ".globl tracer_common_dispatcher\n"
        ".align 16\n"
        "tracer_common_dispatcher:\n"
        "    push %rbx\n"
        "    push %r12\n"
        "    push %r13\n"
        "    push %r14\n"
