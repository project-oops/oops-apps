...
static void test_obs_strncmp(void) {
  TEST(obs_strncmp("hello", "hello world", 5) == 0,
       "obs_strncmp prefix match");
  TEST(obs_strncmp("hello", "hallo", 3) != 0,
       "obs_strncmp prefix mismatch");
}
...
static void test_oops_snprintf(void) {
  ...
  TEST(n == 11 && obs_strcmp(buf, "hello world") == 0,
       "oops_snprintf basic format");
